...
/// </remarks>
public class MNGuiElement_TextButton : GuiElementControl {
    ...
    public MNGuiElement_TextButton(
            ICoreClientAPI capi,
            string text,
    ...
    public override void OnFocusGained() {
        InnerButton.OnFocusGained();
    }

    public override void OnFocusLost() {
        InnerButton.OnFocusLost();
    }
